...
class ZaloAPI(object):
    ...
    async def login(self, phone, password, imei, user_agent=None):
        ...
        try:
            ...
            self.uid = (await self.fetchAccountInfo()).profile.get(
    ...
    async def sendMultiLocalImage(
        ...
        for i, imagePath in enumerate(imagePathList):
            ...
            data = await self.sendLocalImage(
                imagePath,
                thread_id,
                thread_type,
                width,
                        ...
                        try:
                            ...
                            if n == 1 and cmd == 3000 and s == 0:
                                ...
                                for message in groupMsgs:
                                    ...
                                    try:
                                        messages = (
                                            await self.getRecentGroup(message["idTo"])
                                        )["groupMsgs"]
                                        message = next(
                                            (
                                                msg
                                ...
                                for control in controls:
                                    if control["content"]["act_type"] == "group":
                                        ...
                                        event_data = EventObject.fromDict(
                                            groupEventData
                                        )
